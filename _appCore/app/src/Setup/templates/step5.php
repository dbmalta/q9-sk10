...
<form method="post" action="/setup">
    ...
    <div class="row mb-3">
        <div class="col-6">
            ...
            <input type="password" class="form-control" id="admin_password" name="admin_password" minlength="10" required>
            <div class="form-text">Minimum 10 characters.</div>
        </div>
        <div class="col-6">
            <label for="admin_password_confirm" class="form-label">Confirm password</label>
            <input type="password" class="form-control" id="admin_password_confirm" name="admin_password_confirm" minlength="10" required>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between">
        ...
        <button type="submit" class="btn btn-primary">Create Admin <i class="bi bi-arrow-right ms-1"></i></button>
    </div>
</form>
