...
// Demo installs skip the organisation step, so Back goes directly to step 3.
$backStep = (($sessionData['install_type'] ?? '') === 'demo') ? 3 : 4;
?>
...
<form method="post" action="/setup">
    ...
    <div class="d-flex justify-content-between">
        <a href="/setup?step=<?= $backStep ?>" class="btn btn-outline-secondary">
