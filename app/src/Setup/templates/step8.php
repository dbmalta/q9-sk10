...
$installType = $sd['install_type'] ?? 'keep';
$installTypeLabel = match ($installType) {
    'clean' => 'Clean install (all tables dropped)',
    'demo'  => 'Demo install — Scout Association of Filfla',
    default => 'Install without changing the database',
};
?>
...
<?php else : ?>
    ...
    <table class="table table-sm">
        <tbody>
            ...
            <tr>
                <th class="text-muted">Install Type</th>
                <td><?= htmlspecialchars($installTypeLabel) ?></td>
            </tr>
            <?php if ($installType !== 'demo') : ?>
            <tr>
    ...
    <div class="alert alert-warning">
        ...
        The Filfla demo seeder will run when you click Finish. This can take
        2–5 minutes — please do not close the browser. Your admin email and
        password will be preserved so you can still log in.
    </div>
    <?php endif; ?>
